...
\usepackage[scale=0.875, top=1.5cm, bottom=3cm]{geometry} % Reduce document margins
...
\cvitem{Proficient}{Python, PHP, Java, JavaScript, SQL, HTML5, and CSS}
\cvitem{Familiar}{Go, Ruby, Perl, Node.js, Scheme, C, C++, \LaTeX, JSP, PL/SQL, and Visual Basic}

\subsection{Software}

\cvitem{Database}{Oracle, SQL Server, MySQL, PostgreSQL, CouchDB, MongoDB, Redis, and SQLite}
\cvitem{Tools}{Git, Ansible, Fabric, Docker}
